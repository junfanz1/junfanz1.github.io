...
Thus, for short maturities, $$\operatorname{vol}\left(\widehat{\sigma}_{F_{T} T}\right)=2 \mathcal{S}_{T}$$ while for long maturities: 

$$\operatorname{vol}\left(\widehat{\sigma}_{F_{T} T}\right)=$$
